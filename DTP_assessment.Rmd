...
Since the salary coefficients for urban and suburban locales were statistically significant at the 99.9% level, then it's safe to say that among colleges that predominantly grant bachelor's degrees, higher-earning colleges result in more student interest. Given the negative median salaries coefficient for colleges in rural areas, we can say we are 99% confident that among colleges that predominantly grant bachelor's degrees, lower-earning colleges and student interest have a negative relationship. We don't have statistical significance to prove whether or not colleges in towns are linked to higher or lower student interest.
